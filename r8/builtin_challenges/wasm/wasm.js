...
var ASM_CONSTS = {
  1856: function() {let start = window.prompt("Skriv inn hvor du vil starte å lese meldingen fra"); return start},  
 1954: function() {let end = window.prompt("Skriv inn hvor du vil slutte å lese meldingen fra"); return end},  
 2048: function($0) {setMsg($0)}
};
